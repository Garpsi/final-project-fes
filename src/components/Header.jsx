          ...
          <div className="header__row">
            <div className="header__description">
              ...
              <div className="header__btns">
                <button onClick={() => changeName()} className='header__btn'>Name</button>
                <button onClick={() => navigate('/')} className='home__btn'><HomeIcon /></button>
                <button onClick={() => changeGenre()} className='header__btn'>Genre</button>
              </div>
                {
                  !genreBtn ?
